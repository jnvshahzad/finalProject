...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark"
		...
		<a class="navbar-brand" href="sme.jsp"> Trainer Pool Management</a>
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active"><a class="nav-link"
					href="TrainerController?action=viewRequests">View Requests</a></li>
				<li class="nav-item active"><a class="nav-link"
	...
	<div class="container-fluid" style="margin-top: 80px;">
		...
		<c:if test="${editSkills eq true}">
			<div class="card" style="width: 25%;">
				...
				<div class="card-body">
					...
					<form method="POST" action="SME?action=editSkills"
						onsubmit="return checkSkillLength()">
						<div class="row">
								...
								<div class="form-check" id="skills">
									<c:forEach items="${skills}" var="skill">
										<input type="checkbox" class="form-check-input" id="skill"
											name="skill" value="${skill.skillId}">
										<label class="form-check-label" for="skill">${skill.skillName}</label>
										<br />
									</c:forEach>
								</div>
							</div>
		...
		<c:if test="${editAvailability eq true}">
			<div class="card" style="width: 50%;">
				...
				<div class="card-body">
					<form method="POST" action="SME?action=editAvailability"></form>
				</div>
			</div>
		</c:if>
